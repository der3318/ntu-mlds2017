	...
	for i in range(args.epochs):
		for batch_no,(real_images, z_noise, real_caption, false_caption) in enumerate(total_data.get_next_batch()):
			...
			if (batch_no % args.save_every) == 0:
				...
				save_for_vis(args.img_dir, real_images, gen)
				print ("Save for vis finish!")
				#save_path = saver.save(sess, "./data/model/latest_model_temp.ckpt")
				print ("End Save!")
...
def main():
	args = arg_parse()
	total_data = data.Data(test_file="./drive/sample_testing_text.txt")
