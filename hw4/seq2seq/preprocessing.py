...
def gen_training_data(data_path=None, save_path=None, dict_path='dict.txt', vocab_size=5000, min_len=4, valid_ratio=0.01):
    ...
    print(valid_size)
    np.save("{}_train.npy".format(save_path), train_data[valid_size:])
